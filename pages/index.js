            ...
            <div className="mx-4 my-4 md:mx-20 p-4 md:p-10 bg-blue-100 rounded-3xl flex flex-col md:flex-row items-center justify-center">
                ...
                <div>
                    <h1 className="text-3xl md:text-7xl mt-4 text-slate-600">
                        Hello,
                        <br /> I am <span className="font-bold">Aaryamann</span>
                    </h1>
                    ...
                    <div className="text-slate-800">
                        <p className="text-sm md:text-xl flex mb-2">
                            ...
                            <div className="ml-2">
                                ...
                                experience building and deploying scalable and
                                reliable web applications using a variety of
                        ...
                        <p className="text-sm md:text-xl flex mb-2">
                            ...
                            <div className="ml-2">
                                ...
                                development, with a focus on software design and
                                architecture.
                            </div>
                        </p>
                        <p className="text-sm md:text-xl flex mb-2">
                            ...
                            <div clasName="pl-4">
                                <h1 className="ml-2">
                                    Passionate about exploring diverse
                                    technologies, collaborating on new projects
                                    and contributing skills to create innovative
                                    solutions.
                                </h1>
                            </div>
                        </p>
