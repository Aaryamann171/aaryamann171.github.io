...
const ProjectCard = (props) => {
    ...
    if (props.sourceCodeURL) {
        sourceCodeBtn = (
            <button className="bg-blue-600 hover:bg-blue-700 py-2 px-2 md:px-8 border-2 border-blue-600 hover:border-blue-700 rounded">
    ...
    if (props.deploymentURL) {
        deploymentBtn = (
            <button className="py-2 px-2 md:px-8 bg-slate-200 hover:bg-slate-300 rounded">
    ...
    return (
        <div
            className="my-4 md:my-6 mx-4 md:mx-20 bg-blue-100 rounded-3xl md:p-6 overflow-x-hidden
        ...
        >
            <div className="flex flex-col md:flex-row my-4 p-4">
                <div className="md:w-1/3 my-2">
                    <h1 className="md:text-6xl text-3xl mb-10 font-bold text-[#5DE4C7]">
                        {props.projectName}
                    </h1>
                    <p className="text-xl font-light mt-4 mb-10 text-slate-300">
                        {props.projectDesc}
                    </p>
